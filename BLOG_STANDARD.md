...
- Use `jebb-headshot-owner.png` in the branded visual, byline, and author bio. It is the face-forward site headshot that remains legible at avatar size. Do not substitute the half-body About portrait in small circles.
...
6. Jebb's author bio, a relevant verified CTA, and related articles.
